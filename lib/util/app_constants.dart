...
class AppConstants {
  static const String appName = 'LivraShop';
  static const double appVersion = 2.10; ///Flutter Version: 3.24.3

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://web.livrashop.com';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://admin.livrashop.com';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.english, languageName: 'Francais', countryCode: 'FR', languageCode: 'fr'),
